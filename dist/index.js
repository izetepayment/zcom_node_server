...
app.post('/zcom/admin_register', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
app.put('/zcom/admin', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header("jwt");
    ...
    if (jwt == SAdminJwt) {
        if (Number(id)) {
            const result = yield prisma.zcom_admin.update({
                where: { id: Number(id) },
...
app.post('/zcom/login', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header("jwt");
    ...
    if (jwt == SAdminJwt) {
        if (phone && password) {
            if (phone == "9876543210" && password == "12345678") {
                ...
                const result = yield prisma.zcom_admin.findFirst({
                    where: { phone: phone }
                });
                if (result) {
                    const resultPassword = yield prisma.zcom_admin.findFirst({
...
app.get('/zcom/admin', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header("jwt");
    var id = req.query.id;
    ...
    if (jwt == SAdminJwt) {
        const result = yield prisma.zcom_admin.findMany({
...
app.delete('/zcom/admin', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header('jwt');
    var id = req.query.id;
    console.log(jwt);
    ...
    if (jwt == SAdminJwt) {
        if (Number(id)) {
            const result = yield prisma.zcom_admin.deleteMany({
                where: { id: Number(id) }
            });
            if (result) {
...
app.post('/zcom/user_register', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var name = req.body.name;
    var cc = req.body.cc;
    var phone = req.body.phone;
    ...
    if (name && cc && phone && email && password) {
        const resultUser = yield prisma.zcom_user.findFirst({
            where: { phone: phone }
        });
        if (!resultUser) {
            const authkey = require('crypto').randomBytes(16).toString('hex');
            const result = yield prisma.zcom_user.create({
            ...
            const oldUser = yield prisma.zcom_user.findFirst({
                where: { phone: phone }
            });
...
app.post('/zcom/user_verify_otp', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var phone = req.body.phone;
    ...
    if (phone && otp) {
        ...
        if (resultUser) {
            const resultOtp = yield prisma.zcom_user.findFirst({
                where: { AND: [{ phone: phone + "" }, { otp: otp + "" }] }
            });
            if (resultOtp) {
                const updateUser = yield prisma.zcom_user.update({
...
//   }
// })
app.post('/zcom/user_login', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var phone = req.body.phone;
    var password = req.body.password;
    console.log(req.body);
    if (phone && password) {
        const result = yield prisma.zcom_user.findFirst({
            where: { phone: phone }
        });
        if (result) {
            const resultstatus = yield prisma.zcom_user.findFirst({
                where: { AND: [{ phone: phone }, { status: "otpVerified" }] }
            });
            if (resultstatus) {
                const resultPassword = yield prisma.zcom_user.findFirst({
                    where: { AND: [{ phone: phone }, { password: password }] }
                });
                if (resultPassword) {
...
app.get('/zcom/user', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var id = req.query.id;
    var phone = req.query.phone;
    console.log(req.query);
    const result = yield prisma.zcom_user.findMany({
        where: { AND: [id ? { id: Number(id) } : {}, phone ? { phone: phone + "" } : {}] },
        orderBy: { id: "asc" },
    });
    if (result) {
...
app.delete('/zcom/user', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var id = req.query.id;
    if (id) {
        const result = yield prisma.zcom_user.delete({
            where: { id: Number(id) }
        });
        if (result) {
...
app.post('/zcom/categories', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header('jwt');
    ...
    if (jwt == SAdminJwt) {
        if (category && image) {
            const result = yield prisma.zcom_categories.create({
...
app.put('/zcom/categories', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header('jwt');
    var category = req.body.category;
    var image = req.body.image;
    ...
    if (jwt == SAdminJwt) {
        console.log(req.body);
        if (id) {
            const result = yield prisma.zcom_categories.update({
                where: { id: Number(id) },
                data: { category: category, image: image }
            });
            if (result) {
...
app.get('/zcom/categories', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header('jwt');
    var id = req.query.id;
    if (jwt == SAdminJwt) {
        const result = yield prisma.zcom_categories.findMany({
...
app.delete('/zcom/categories', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header('jwt');
    var id = req.query.id;
    if (jwt == SAdminJwt) {
        if (id) {
            const result = yield prisma.zcom_categories.delete({
                where: { id: Number(id) }
            });
            if (result) {
...
app.post('/zcom/subcategories', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header('jwt');
    ...
    if (jwt == SAdminJwt) {
        if (categoryId && subCategory) {
            const result = yield prisma.zcom_subcategories.create({
...
app.put('/zcom/subcategories', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header('jwt');
    var categoryId = req.body.categoryId;
    var subCategory = req.body.subCategory;
    ...
    if (jwt == SAdminJwt) {
        console.log(req.body);
        if (Number(id)) {
            const result = yield prisma.zcom_subcategories.update({
                where: { id: Number(id) },
                data: { categoryId: categoryId, subCategory: subCategory }
            });
            if (result) {
...
app.get('/zcom/subcategories', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header('jwt');
    var id = req.query.id;
    console.log(jwt);
    console.log("cat");
    if (jwt == SAdminJwt) {
        const result = yield prisma.zcom_subcategories.findMany({
            where: id ? { id: Number(id) } : {},
            orderBy: { id: "desc" }
        });
...
app.delete('/zcom/subcategories', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header('jwt');
    var id = req.query.id;
    if (jwt == SAdminJwt) {
        if (id) {
            const result = yield prisma.zcom_subcategories.delete({
                where: { id: Number(id) }
            });
            if (result) {
...
app.post('/zcom/stock', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    ...
    if (jwt == SAdminJwt) {
        if (vendorId && categoryId && subcategoryId && sku && productName && image && price && strikePrice && qty && discount && coupon &&
            ...
            const result = yield prisma.zcom_stock.create({
                data: {
...
app.put('/zcom/stock', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var vendorId = req.body.vendorId;
    var categoryId = req.body.categoryId;
    var subcategoryId = req.body.subcategoryId;
    ...
    if (jwt == SAdminJwt) {
        if (Number(id)) {
            const result = yield prisma.zcom_stock.update({
                where: { id: Number(id) },
                data: {
                    vendorId: vendorId, categoryId: categoryId, subcategoryId: subcategoryId, sku: sku, productName: productName, image: image,
                    price: price, strikePrice: strikePrice, qty: qty, discount: discount, coupon: coupon, shipPrice: shipPrice, stockUpdate: stockUpdate,
...
app.get('/zcom/stock', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var vendorDet = new Map();
    var categoryDet = new Map();
    var subcatDet = new Map();
    (yield prisma.zcom_admin.findMany()).forEach((element) => {
        vendorDet.set(element.id + "", element.name);
    });
    (yield prisma.zcom_categories.findMany()).forEach((element) => {
        categoryDet.set(element.id + "", element.category);
    });
    (yield prisma.zcom_subcategories.findMany()).forEach((element) => {
        subcatDet.set(element.id + "", element.subCategory);
    });
    var jwt = req.header('jwt');
    var id = req.query.id;
    if (jwt == SAdminJwt) {
        const result = (yield prisma.zcom_stock.findMany({
            where: id ? { id: Number(id) } : {},
            orderBy: { id: "desc" }
...
app.delete('/zcom/stock', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var jwt = req.header('jwt');
    var id = req.query.id;
    if (jwt == SAdminJwt) {
        if (Number(id)) {
            const result = yield prisma.zcom_stock.delete({
                where: { id: Number(id) }
            });
            if (result) {
...
app.post('/zcom/banner', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var title = req.body.title;
    var banner = req.body.banner;
    console.log(req.body);
    if (title && banner) {
        const result = yield prisma.zcom_banner.create({
...
app.put('/zcom/banner', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var title = req.body.title;
    var banner = req.body.banner;
    var id = req.body.id;
    console.log(req.body);
    if (id) {
        const result = yield prisma.zcom_banner.update({
            where: { id: Number(id) },
            data: { title: title, banner: banner }
        });
        if (result) {
...
app.get('/zcom/banner', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var id = req.query.id;
    const result = yield prisma.zcom_banner.findMany({
        where: id ? { id: Number(id) } : {},
        orderBy: { id: "desc" }
    });
    res.json({ "data": result, "message": "Banner successfully Fetched.", "success": true });
}));
app.delete('/zcom/banner', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var id = req.query.id;
    if (id) {
        const result = yield prisma.zcom_banner.delete({
            where: { id: Number(id) }
        });
        if (result) {
...
app.post('/zcom/fileUpload', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    upload(req, res, (err) => {
        if (err) {
...
app.get('/zcom/get_Images', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    fs_1.default.readdir("./images", function (err, files) {
        if (err) {
            res.json();
        }
        let filesv = "";
...
app.delete('/zcom/fileDelete', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // await executeLatinFunction()
    var name = req.query.name;
    if (name) {
        fs_1.default.unlink('./images/' + name, (err) => {
            if (err) {
...
app.use(express_1.default.static(__dirname + '/zcom/images'));
app.get('/zcom/images/*', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const search = "%20";
